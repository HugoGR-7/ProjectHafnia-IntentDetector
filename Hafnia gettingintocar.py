...
clip_path = "videos/gettingintocar_normal.mp4"
...
or even robbing the cars. Follow exactly this JSON schema; if uncertain, use "uncertain".
...
Be precise with timing and reasoning. Give a 1 to 10 score of your confidence about the decision"""
